 ...
 *
 * @checksum - 89b5dfcfc81eabcaa13ec21d44dddff75d1a1e20b3b23a1201faf2e361312ed5
 * @variables - radius=rounded,accentColor=sky,colorTemperature=slate,spacing=1.5,scale=sm,inputShadow=shadow-none,baseColorShade=600,borderShadeLightMode=300,borderShadeDarkMode=700,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:box__decorator": {
    ...
    "bg-white": true,
    "ring-sky-500": true,
    "peer-checked:border-sky-600": true,
    relative: true,
    block: true,
    "text-base": true,
    "w-[1em]": true,
    ...
    "peer-checked:text-sky-600": true,
    ...
    "dark:bg-zinc-950": true,
    "dark:ring-offset-sky-500": true,
    "dark:peer-focus-visible:ring-1": true,
    "dark:peer-disabled:bg-slate-600/50": true,
    "dark:peer-checked:bg-sky-900": true,
    "dark:peer-checked:text-sky-400": true,
  },
  ...
  "family:text__inner": {
    ...
    "focus-within:!ring-sky-500": true,
    "focus-within:!border-sky-500": true,
  ...
  "family:dropdown__listbox": {
    ...
    "group-data-[overscroll]:border-slate-200": true,
    "group-data-[overscroll]:dark:border-zinc-700": true,
  },
  "family:dropdown__listitem": {
    ...
    "data-[is-active]:before:ring-sky-500": true,
  ...
  "family:dropdown__tagWrapper": {
    ...
    "data-[active-selection=true]:ring-sky-500": true,
  },
  ...
  "family:dropdown__tag": {
    ...
    "group-data-[active-selection=true]/tag:bg-sky-400": true,
  ...
  color__inner: {
    ...
    "group-data-[prefix-icon]:border-slate-300": true,
    "group-data-[suffix-icon]:border": true,
    "group-data-[suffix-icon]:border-slate-300": true,
  ...
  file__fileRemove: {
    ...
    "peer-data-[has-multiple]:text-sky-600": true,
  ...
  form__messageLink: {
    ...
    "group-[]/summary:ring-sky-600": true,
  },
  month__input: {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  range__input: {
    ...
    "group/input": true,
    "cursor-pointer": true,
    "[&::-webkit-slider-runnable-track]:bg-slate-300/50": true,
    ...
    "[&::-webkit-slider-thumb]:bg-sky-600": true,
    ...
    "[&::-webkit-slider-thumb]:group-data-[disabled]:!ring-slate-200": true,
    "[&::-webkit-slider-thumb]:focus-visible:ring-2": true,
    "[&::-webkit-slider-thumb]:focus:!ring-sky-500": true,
    "[&::-webkit-slider-thumb]:focus:ring-offset-2": true,
    "[&::-webkit-slider-thumb]:shadow-none": true,
    "dark:[&::-webkit-slider-thumb]:group-data-[disabled]:!ring-slate-700":
      true,
    "dark:[&::-webkit-slider-thumb]:focus:ring-offset-slate-700": true,
    "[&::-moz-range-track]:bg-slate-300/50": true,
    ...
    "[&::-moz-range-thumb]:bg-sky-600": true,
    ...
    "[&::-moz-range-thumb]:focus:!ring-sky-500": true,
  ...
  submit__input: {
    ...
    "active:bg-sky-700": true,
    "hover:bg-sky-700": true,
    "disabled:border-slate-300": true,
  ...
  colorpicker__fieldGroup: {
    ...
    "[&>input:focus]:ring-sky-600": true,
    "[&>input:focus]:border-sky-600": true,
  ...
  colorpicker__swatch: {
    ...
    "[&>canvas:focus-visible]:ring-sky-500": true,
  ...
  datepicker__dayCell: {
    ...
    "dark:bg-slate-600": true,
    "dark:text-slate-300": true,
    "dark:aria-selected:bg-sky-600": true,
    "dark:aria-selected:text-white": true,
    "dark:focus:outline-sky-600": true,
  ...
  rating__ratingItem: {
    ...
    "focus-within:outline-sky-600": true,
    "w-[1.5em]": true,
    "h-[1.5em]": true,
  },
  ...
  slider__minValue: {
    ...
    "[&>div>div::after]:bg-slate-300": true,
  ...
  toggle__track: {
    ...
    "shadow-none": true,
    "peer-focus-visible:ring-2": true,
    "peer-focus-visible:ring-sky-500": true,
  ...
  togglebuttons__input: {
    ...
    "dark:text-sky-500": true,
    "aria-[pressed=true]:bg-sky-600": true,
    "aria-[pressed=true]:text-white": true,
    "dark:aria-[pressed=true]:bg-sky-600": true,
    ...
    "group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-sky-500":
      true,
    "group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-sky-600":
      true,
    "group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-sky-600":
      true,
    "dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-sky-600":
      true,
    "dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-sky-600":
      true,
    "dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-sky-600":
      true,
    ...
    "group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-sky-500":
      true,
    "group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-sky-600":
      true,
    "group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-sky-600":
      true,
    "dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-sky-600":
      true,
    "dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-sky-600":
      true,
    "dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-sky-600":
      true,
  },
  transferlist__outer: {
    group: true,
    ...
    "text-sm": true,
    "max-w-none": true,
    "[&_.dnd-placeholder]:bg-sky-600": true,
  ...
  transferlist__transferlist: {
    ...
    "[&:has(:focus-visible)]:ring-sky-500": true,
    "dark:border-zinc-800": true,
  ...
  transferlist__transferlistListItem: {
    ...
    "dark:bg-slate-800": true,
    "dark:text-slate-300": true,
    "dark:data-[is-active=true]:bg-sky-900": true,
    "dark:aria-selected:bg-sky-900": true,
  ...
  "multi-step__tabs": {
    ...
    "group-data-[tab-style=tab]/wrapper:border-slate-200": true,
  ...
  "multi-step__tab": {
    ...
    "dark:group-data-[tab-style=progress]/wrapper:before:border-slate-800":
      true,
    ...
    "group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-sky-600":
      true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-sky-600":
      true,
  },
  ...
  "multi-step__badge": {
    ...
    "text-white": true,
    "rounded-full": true,
    "group-data-[valid=true]/tab:bg-sky-600": true,
